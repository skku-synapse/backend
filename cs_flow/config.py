...
class_name = "camera_cropped"  # dataset subdirectory
modelname = "camera_cropped"  # export evaluations/logs with this name
...
meta_epochs = 12  # total epochs = meta_epochs * sub_epochs
