...
def make_dataloaders_with_batchSize(trainset, testset, bs):
    trainloader = torch.utils.data.DataLoader(trainset, pin_memory=True, batch_size=bs, shuffle=True,
                                              drop_last=False)
    testloader = torch.utils.data.DataLoader(testset, pin_memory=True, batch_size=bs, shuffle=False,
                                             drop_last=False)
    return trainloader, testloader
